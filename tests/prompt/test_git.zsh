...
typeset _fixture_root=$(mktemp -d "${TMPDIR:-/tmp}/prompt-shimoju-git.XXXXXXXX")
...
typeset -a result
result=("${(Q@)${(z)$(prompt_shimoju_async_git_branch 7 "$_fixture_root")}}")
...
result=("${(Q@)${(z)$(prompt_shimoju_async_git_status 7 "$_fixture_root")}}")
...
prompt_shimoju_generation=8
prompt_shimoju_git_branch=keep
prompt_shimoju_async_callback prompt_shimoju_async_git_branch 0 \
  "$(prompt_shimoju_async_git_branch 7 "$_fixture_root")" 0 '' 0
assert_equal keep "$prompt_shimoju_git_branch" 'rejects a stale generation'

builtin cd -q -- "$_fixture_root"
prompt_shimoju_generation=7
prompt_shimoju_async_callback prompt_shimoju_async_git_branch 0 \
  "$(prompt_shimoju_async_git_branch 7 "$_fixture_root")" 0 '' 0
assert_equal main "$prompt_shimoju_git_branch" 'accepts the current branch generation'
prompt_shimoju_async_callback prompt_shimoju_async_git_status 0 \
  "$(prompt_shimoju_async_git_status 7 "$_fixture_root")" 0 '' 0
assert_equal 'main*+? ⇣⇡ ≡' "$prompt_shimoju_git_plain" 'builds a unified Git segment'
